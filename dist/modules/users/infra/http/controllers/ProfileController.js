...
class ProfileController {
  async show(request, response) {
    ...
    const showProfile = await _tsyringe.container.resolve(_ShowProfileService.default);
  ...
  async update(request, response) {
    ...
    const updateProfile = await _tsyringe.container.resolve(_UpdateProfileService.default);
